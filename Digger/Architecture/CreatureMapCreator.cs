...
namespace Digger.Architecture
{
    public static class CreatureMapCreator
    {
        ...
        private static ICreature CreateCreatureBySymbol(char c)
        {
            ...
            {
                case 'P':
                    return CreateCreatureByTypeName(nameof(Player));
                case 'T':
                    return CreateCreatureByTypeName(nameof(Terrain));
                case 'G':
                    return CreateCreatureByTypeName(nameof(Gold));
                case 'S':
                    return CreateCreatureByTypeName(nameof(Sack));
                case 'M':
                    return CreateCreatureByTypeName(nameof(Monster));
                case ' ':
                    return null;
                default:
