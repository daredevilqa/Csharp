...
namespace Digger.Architecture
{
    public class DiggerWindow : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString($"Score: {Game.Scores.ToString()}", new Font("Arial", 18), Brushes.Green, 0, 0);
            if (Game.IsOver) {
                e.Graphics.DrawString("GAME OVER :E", new Font("Arial", 18), Brushes.DarkRed, 130, 0);
            }
        }
